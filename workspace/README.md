...
```sh PAUL-LAPTOP
#SANDBOX
IP_APP="192.168.202.124" IP_INFRA="192.168.202.125" IP_DEPLOY="192.168.202.126" GROUP="SANDBOX" INTERFACE_NET="Realtek 8852CE WiFi 6E PCI-E NIC" SCRIPT_INITIAL="sandbox_script.sh" vagrant up
IP_APP="192.168.18.141" IP_INFRA="192.168.18.142" IP_DEPLOY="192.168.18.143" GROUP="SANDBOX" INTERFACE_NET="enp0s31f6" SCRIPT_INITIAL="sandbox_script.sh" vagrant halt
IP_APP="192.168.18.141" IP_INFRA="192.168.18.142" IP_DEPLOY="192.168.18.143" GROUP="SANDBOX" INTERFACE_NET="enp0s31f6"  SCRIPT_INITIAL="sandbox_script.sh" vagrant reload --provision
IP_APP="192.168.18.141" IP_INFRA="192.168.18.142" IP_DEPLOY="192.168.18.143" GROUP="SANDBOX" INTERFACE_NET="enp0s31f6" vagrant destroy
